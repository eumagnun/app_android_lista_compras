...
class ItemAdapter(val dados:List<Produto>, val onProdutoClickListener
    : OnProdutoClickListener):RecyclerView.Adapter<ItemAdapter.ItemViewHolder>() {

    class  ItemViewHolder(view: View, val onProdutoClickListener
    : OnProdutoClickListener):RecyclerView.ViewHolder(view), View.OnClickListener{
